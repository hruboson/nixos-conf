          ...
          programs.nixvim = {
            ...
            keymaps = [
              # INSERT
              {
                ...
                key = "<C-H>";
                action = "<C-W>";
                options.desc = "Ctrl+Backspace";
              }
              {
                mode = "i";
                key = "<C-BS>";
                action = "<C-W>";
                options.desc = "Ctrl+Backspace (neovide)";
              }
              {
                mode = "i";
                key = "<C-Del>";
                action = "<C-o>\"_dw";
                options.desc = "Ctrl+Delete";
              }
              ...
              }
              {
                mode = "n";
                key = "=";
                action = "<cmd>lua require('conform').format({ range = { start = { vim.fn.line('.'), 0 }, ['end'] = { vim.fn.line('.'), -1 } } })<CR>";
                options.desc = "Format line";
              }
              ...
              }
              {
                ...
                options.desc = "Toggle code outline window";
              }
              ...
              # NORMAL - misc
              {
                ...
                key = "<leader>rme";
                action = ":%s/\r//g<CR>";
                options.desc = "Remove ^M carriage returns";
              }
