# Original theme: https://github.com/ohmyzsh/ohmyzsh/blob/master/themes/mh.zsh-theme
# Customized for my needs

# Set username color based on user
if [ $UID -eq 0 ]; then 
    NCOLOR="red"      # Root user = red (changed from green)
else 
...
# Git theming - branch appears in yellow
