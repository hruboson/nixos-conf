{ self, inputs, ... }: {
  flake.nixosModules.selfhostedGlance =
    {
      config,
      lib,
      pkgs,
              ...
              columns = [
                {
                  ...
                  widgets = [
                    { type = "calendar"; }
                    {
                      ...
                      cache = "1d";
                      url = "https://api.nasa.gov/planetary/apod?api_key=${inputs.secrets.apiNasaKey}";
                      headers = {
                      ...
                      groups = [
                          ...
                          links = [
                            {
                              ...
                              icon = "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fstatic.vecteezy.com%2Fsystem%2Fresources%2Fpreviews%2F022%2F613%2F021%2Fnon_2x%2Fgoogle-mail-gmail-icon-logo-symbol-free-png.png&f=1&nofb=1&ipt=54fbd04122c0938a13ede90083e4ab1e53f522872f24062bad6a991a962cef54";
                            }
                            {
                              title = "Moodle";
                              url = "https://moodle.utb.cz/my/";
                              icon = "https://www.google.com/s2/favicons?domain=moodle.utb.cz";
                            }
                            {
                              title = "UTB";
                              url = "http://stag.utb.cz";
                              icon = "https://www.google.com/s2/favicons?domain=stag.utb.cz";
                            }
                          ];
                        }
                        {
                          ...
                          links = [
                            {
                              ...
                              url = "https://dash.hrubos.dev";
                              icon = "di:glance";
                            }
                            {
                              title = "Github";
                              url = "https://github.com/hruboson";
                              icon = "https://www.google.com/s2/favicons?domain=github.com";
                            }
                            {
                              title = "Portfolio";
                              url = "http://www.hrubos.dev/";
                              icon = "https://hrubos.dev/img/logo-courier-sm.ico";
                            }
                          ];
                        }
                        {
                          ...
                          links = [
                            {
                              ...
                              icon = "https://www.google.com/s2/favicons?domain=techhub.social";
                            }
                            {
                              title = "Reddit";
                        ...
                        }
                        {
                          ...
                          links = [
                            ...
                            }
                            {
                              ...
                              icon = "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fclipartcraft.com%2Fimages%2Ftwitch-logo-png-twitter.png&f=1&nofb=1&ipt=dd77af44814daaac82c721ad5d86a6e34ecafcfaf2ed12b9133d94d7cec93f71&ipo=images";
                            }
                            {
                              title = "CSFD";
                            ...
                            }
                            {
                              ...
                              icon = "https://www.google.com/s2/favicons?domain=cineby.gd";
                            }
                            {
                              title = "Miruro";
                              url = "https://www.miruro.to";
                              icon = "https://www.google.com/s2/favicons?domain=miruro.to";
                            }
                            {
                              title = "AL";
                        ...
                        }
                        {
                          ...
                          links = [
                            ...
                            }
                            {
                              ...
                              icon = "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fimages.chesscomfiles.com%2Fuploads%2Fv1%2Fimages_users%2Ftiny_mce%2FSamCopeland%2FphpmeXx6V.png&f=1&nofb=1&ipt=8761ef6305d20fff4bc2538f125a3ee514f036b762b0e879a59434e6d6486d62&ipo=images";
                            }
                            {
                              title = "Royal Ur";
                              url = "https://royalur.net";
                              icon = "https://www.google.com/s2/favicons?domain=royalur.net";
                            }
                            {
                              title = "Typeracer";
                              url = "http://play.typeracer.com";
                              icon = "https://www.google.com/s2/favicons?domain=play.typeracer.com";
                            }
                            {
                              title = "lolesports";
                              url = "https://lolesports.com/en-GB/";
                              icon = "https://www.google.com/s2/favicons?domain=lolesports.com";
                            }
                            {
                              title = "valorantesports";
                        ...
                        }
                        {
                          ...
                          links = [
                            {
                              title = "Zoom Earth";
                              url = "https://www.zoom.earth/";
                              icon = "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Fzoom.earth%2Fassets%2Fimages%2Ficon-400.jpg&f=1&nofb=1&ipt=9672bf7b3ab9914afd3dad9ff596693da7fbfa4b760ea678cfa26cb1b62e7c17&ipo=images";
                            }
                            {
                              title = "Trading212";
                              url = "https://www.trading212.com/";
                              icon = "https://www.google.com/s2/favicons?domain=trading212.com";
                            }
                            {
                              title = "Messenger";
